...
// === Распознавание речи ===function startRecognition() {
...
// === Камера на фоне ===async function startCamera() {
 try {
